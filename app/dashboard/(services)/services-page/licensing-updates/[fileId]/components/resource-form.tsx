...
export const ResourceForm = ({ initialData }: ResourceFormProps) => {
	...
	const title = initialData ? `Edit Updates` : `Create Updates`
	const description = initialData ? `Edit a Updates. ` : `Add a new Updates`
	const toastMessage = initialData ? `Updates updated.` : `Updates created.`
	...
	const onSubmit = async (data: ResourceFormValues) => {
		try {
			...
			router.refresh()
			router.push(`/dashboard/services-page/licensing-updates`)
						...
						render={({ field }) => (
							<FormItem>
								...
								<FormControl>
									<Input
										disabled={loading}
										placeholder="Licence Updates Title"
										{...field}
									/>
								</FormControl>
								<FormMessage />
