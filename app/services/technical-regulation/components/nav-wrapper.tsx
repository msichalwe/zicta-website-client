...
const NavWrapper: React.FC<NavProps> = ({ children }) => {
	...
	const routes = [
		{
			href: `/services/technical-regulation`,
			label: 'Technical Regulation',
			active: pathname === '/services/technical-regulation',
		},
		{
			href: `/services/technical-regulation/dealer-registry`,
			label: 'Registered Dealers',
			active: pathname === '/services/technical-regulation/dealer-registry',
		},
	]
			...
			<div className="flex gap-10 w-full flex-col my-10">
				<div className="bg-gradient-to-l  mt-10 md:mt-0 to-zicta-blue from-[#7CA5B8]  w-full flex-col bg-cover  h-full sm:min-h-[400px] min-h-[200px] flex items-center justify-center">
					<h1 className="sm:text-4xl text-2xl  text-white font-medium">
						<Balancer>Technical Regulation</Balancer>
					</h1>
				...
				<div className="w-5/6 mx-auto">
					<h2
						...
						onClick={() => router.push('/services/technical-regulation')}>
